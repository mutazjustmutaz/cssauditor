...
Note #1: CSS folders are NOT searched recursively, while HTML/PHP folders are searched recursively.

Note #2: Don't forget to put the path in double quotes if it contains spaces.
